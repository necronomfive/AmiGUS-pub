...
#define AMIGUS_SAMPLE_FORMAT_FLAG_SWAP_CHANNELS   0x0004
#define	AMIGUS_SAMPLE_FORMAT_FLAG_LITTLE_ENDIAN   0x0008
#define	AMIGUS_SAMPLE_FORMAT_FLAG_UNSIGNED        0x0010
