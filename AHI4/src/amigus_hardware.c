...
const UWORD AmiGUSSampleSizes[ AMIGUS_PCM_SAMPLE_FORMAT_COUNT ] = {
  ...
  1, // AMIGUS_PCM_SAMPLE_FORMAT_MONO_8BIT    @ index 0x0000
  2, // AMIGUS_PCM_SAMPLE_FORMAT_STEREO_8BIT  @ index 0x0001
  2, // AMIGUS_PCM_SAMPLE_FORMAT_MONO_16BIT   @ index 0x0002
  4, // AMIGUS_PCM_SAMPLE_FORMAT_STEREO_16BIT @ index 0x0003
  3, // AMIGUS_PCM_SAMPLE_FORMAT_MONO_24BIT   @ index 0x0004
  6  // AMIGUS_PCM_SAMPLE_FORMAT_STEREO_24BIT @ index 0x0005
};
