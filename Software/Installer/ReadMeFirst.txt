...
What is included?
- The distribution consists of four files so far:
  - AmiGUS-Tools-<YYYYmmDD>.adf
    Contains the AmiGUS Base Tools and all Drivers meant for OS 2.0 and
    above, including an Installer script.
    Very likely, you will want to use this. ;-)
  - AmiGUS-Manual-<YYYYmmDD>.adf
    ...
    Works on OS 2.1 and above, but looks best in OS 3.2 and above.
  - AmiGUS-OS13-<YYYYmmDD>.adf
    This is the ONLY disk readable to OS 1.3 machines - and it is meant for
  ...
  - AmiGUS-<YYYYmmDD>.lha
    Contains all of the above - but only the installers for OS 2.0 or above.
...
- For installation instructions, please check the manual,
  ...
  Worst case, please check out https://github.com/necronomfive/AmiGUS-pub/
...
- In case you experience issues with a missing Installer or the installation
  does not work as expected on the Installer version in your OS 2.0 or above,
  please try the latest Commodore / ESCOM / Amiga Technologies Installer 
  from:
...
- To view the AmigaGuide manual on AmigaOS versions earlier than 3.0, 
